  ...
  void _kayitOl() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          // --- HİÇ SORMADAN DOĞRUDAN YÖNLENDİRME ---
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => _isBarber 
                  ? const BusinessMainNavigation() 
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) => !value!.contains("@") ? "Geçerli bir e-posta girin" : null,
                  ),
                  const SizedBox(height: 16),
                  ...
                  TextFormField(
                    ...
                    validator: (value) => value!.length < 10 ? "Geçerli bir telephone numarası girin" : null,
                  ),
                  const SizedBox(height: 16),
                  ...
                  // Berber / Dükkan Sahibi Seçeneği (Switch)
                  SwitchListTile(
                  ...
                  // DİNAMİK ALAN: Eğer Berber seçildiyse Dükkan İsmi alanı görünür
                  if (_isBarber) ...[
                    TextFormField(
                  ...
                  _isLoading
                      ...
                      : SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              _isBarber ? "Berber Olarak Kaydol" : "Müşteri Olarak Kaydol",
